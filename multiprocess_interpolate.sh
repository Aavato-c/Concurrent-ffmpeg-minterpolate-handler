...
m_args_2="setpts=62.5*PTS,minterpolate='fps=25:mb_size=16:search_param=400:vsbmc=0:scd=none:mc_mode=aobmc:me_mode=bilat:me=ntss"
...
# USAGE
# ./multiprocess_interpolate.sh -i input.mp4 -r 60 -s 00:00:00 -t 00:00:10 -e libx264 -p 0 -d 00:00:10 -b /usr/bin/ffmpeg -m "setpts=62.5*PTS,minterpolate='fps=25:mb_size=16:search_param=400:vsbmc=0:scd=none:mc_mode=aobmc:me_mode=bilat:me=ntss:mi_mode=mci:mc_mode=aobmc:me_mode=bidir:vsbmc=1" -f "-crf 20 -preset slow" output.mp4

# SIMPLE USAGE (default values)
# ./multiprocess_interpolate.sh -i input.mp4 output.mp4